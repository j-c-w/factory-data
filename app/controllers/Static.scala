...
object Static {
  ...
  object Assets {
    val filterHelp = ("Filter Help", "A description of help")
    val aggregateHelp = ("Aggregate Help", "Help")
    val sortHelp = ("Sort Help", "help")
    val graphHelp = ("Graph Help", "help")
    val columnHelp = ("Column Help", "help")
  }
}
